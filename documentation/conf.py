...
def _import_version( ):
    ...
    module = import_module( 'vibecontrols' )
...
linkcheck_ignore = [
    ...
    r'https://emcd\.github\.io/vibe-py-controls/.*',
    ...
    r'https://github\.com/emcd/vibe-py-controls',
    r'https://github\.com/emcd/vibe-py-controls/.*',
    # Package does not exist during initial development.
    r'https://pypi.org/project/vibe-controls/',
